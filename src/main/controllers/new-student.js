  ...
  function EjecutaResgistro(ArrayUsuario){
      $.ajax({
        ...
        url: GetUrl.ROOT_MAIN_CON + "/models/RunInsertNewStudent.php",       
        success: function(res){            
            ...
            if(!data['res']){
              ...
              setTimeout(function(){ window.location.assign(GetUrl.ROOT_MEDIA_USER); }, 2200);
            }             
        }//Fin success
  ...
  function EstudianteRegistrado(codEstudiante){ 
    ...
    return new Promise(resolve => {  
      $.ajax({
          url: GetUrl.ROOT_MAIN_CON + '/models/verificate_user.php',
          type: 'POST',
