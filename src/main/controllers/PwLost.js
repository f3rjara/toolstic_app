...
function validarusuario(codigo){
    return new Promise(resolve => {  
        $.ajax({
            type: "POST",
            data: { codigo: codigo  },        
            url: GetUrl.ROOT_MAIN_CON + "/models/vluseres.php", 
...
function validarCorreo(Correousuario, codigo){
    return new Promise(resolve => {  
        $.ajax({
            ...
            url: GetUrl.ROOT_MAIN_CON + "/models/vlmailuseres.php",             
            success: function(res){   
                var data = jQuery.parseJSON(res);              
                if(!data['res']){
                    Swal.fire(
    ...
    return new Promise(resolve => {  
        $.ajax({
            ...
            data: { 
                ...
                codigo: codigo,
                codgen: codgen  },        
            url: GetUrl.ROOT_MAIN_CON + "/models/sendmailuseres.php",             
            success: function(res){     
...
function  updatePass(password, cod_estudiante ) {
    return new Promise(resolve => {  
        $.ajax({
            ...
            url: GetUrl.ROOT_MAIN_CON + "/models/updpassuseres.php",             
            success: function(res){     
