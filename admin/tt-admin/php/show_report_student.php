...
<?php 
    $checkCuest =  checkReslut ( $conex , $_GET['codget'] ) ;
    $datosCues = $checkCuest['data'];            
    $DataResul = SaveResultCuestionario($_GET['codget'], $datosCues['id_cuestionario'], $conex); 
    include_once ('./php/resu_data.php'); 

    $insEstu = EstudianteInscrito($_GET['codget'], $conex); 
    ...
    $ResultCuestEstu  = FullDataResulCuestEstu($conex, $_GET['codget']);
    $FullDataInsc = FullDataInscEstu($conex, $_GET['codget'] );  
    $FullCuestionario = EstudianteFullCuestionario($id_inscripcion, $_GET['codget'], $conex);
    ...
    $EstudianteReload = DatosEstudiantesReload($conex,$_GET['codget']);
?>
...
<div class="row" >
    ...
    <div class="col s12 m6 l3">
        <div class="card ">
            <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="./../../public/img/comp_1.png">
            </div>
    ...
    <div class="col s12 m6 l3">
        <div class="card ">
            <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="./../../public/img/comp_2.png">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">
                <i class="material-icons right">more_vert</i>
    ...
    <div class="col s12 m6 l3">
        <div class="card ">
            <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="./../../public/img/comp_3.png">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">
                <i class="material-icons right">more_vert</i>
    ...
    <div class="col s12 m6 l3">
        <div class="card ">
            <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="./../../public/img/comp_4.png">
            </div>
            <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">
                <i class="material-icons right">more_vert</i>
