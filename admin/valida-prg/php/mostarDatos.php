    ...
    if($LosDatos->num_rows > 0){
        ...
        $card = " 
            ...
            <div class='card-content ToolsticBlanco'>
                <span class='card-title'><b>".utf8_encode($datos['nombres_usuario'])." ".utf8_encode($datos['apellidos_usuario'])."</b></span> <hr>
            ...
            <div class='card-content left-align white-text ToolsTic_Blue darken-2'>
                ...
                <div class='user-data'>
                    <b><i class='material-icons active'>contact_mail</i></b> &nbsp;
